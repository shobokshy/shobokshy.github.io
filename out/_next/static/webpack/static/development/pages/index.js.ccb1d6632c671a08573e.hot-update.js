    ...
    value: function render() {
      return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_5__["jsx"])("div", {
        css: {
          ...
          height: '98vh',
          width: '100%',
          backgroundImage: "linear-gradient(-156deg, ".concat(this.state.data.background_gradient_color_1, " 19%, ").concat(this.state.data.background_gradient_color_2, " 100%) !important")
        },
        __source: {
        ...
        src: this.state.data.feature_image.url,
        alt: this.state.data.feature_image.alt,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 56
        },
        ...
        __self: this
      }, this.state.data.github_link.target && Object(_emotion_core__WEBPACK_IMPORTED_MODULE_5__["jsx"])("a", {
        target: this.state.data.github_link.target,
        href: this.state.data.github_link.url,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 71
        },
...
//# sourceMappingURL=index.js.ccb1d6632c671a08573e.hot-update.js.map